<?php
interface iPlanes_de_contingencia{

}

class Planes_de_contingencia extends Estructura implements iPlanes_de_contingencia{

	function __construct($id = ""){
		$this->nombre_tabla = "planes_de_contingencia";
		$this->titulo_tabla = "Planes de contingencia";
        $this->titulo_tabla_singular = "Plan de contingencia";
		$this->tabla_padre = "";

		$this->drop_label_elija = "Elija un Plan de contingencia";
