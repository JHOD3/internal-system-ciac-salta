<?php
interface iTareas_configuracion{

}

class Tareas_configuracion extends Estructura implements iTareas_configuracion{

	function __construct($id = ""){
		$this->nombre_tabla = "tareas_configuracion";
		$this->titulo_tabla = "Configuraciones de Tareas";
        $this->titulo_tabla_singular = "Configuración de Tarea";
		$this->tabla_padre = "";

		$this->drop_label_elija = "Elija una Configuración de Tarea";
