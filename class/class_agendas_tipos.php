<?php
interface iAgendas_Tipos{

}

class Agendas_Tipos extends Estructura implements iAgendas_Tipos{

	function __construct($id = ""){
		$this->nombre_tabla = "agendas_tipos";
		$this->titulo_tabla = "Tipo de Contacto";
		$this->tabla_padre = "";

		$this->drop_label_elija = "Elija un Tipo de Contacto";
