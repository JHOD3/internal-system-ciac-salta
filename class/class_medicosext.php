<?php
interface iMedicosext{

}

class Medicosext extends Estructura implements iMedicosext{

	function __construct($id = ""){
		$this->nombre_tabla = "medicosext";
		$this->titulo_tabla = "Médicos Externos";
		$this->tabla_padre = "";

		$this->drop_label_elija = "Elija un Médio Externo";
