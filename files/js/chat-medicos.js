            ...
            .then(response => {
                ...
                if (response != false) {
                    for (let i = 0; i < response.length; i++) {
                        ...
                        let count = (parseInt(response[i].count)!=0 && response[i].id_medico == response[i].chat_id_usuario)?'<span class="chat-count">'+response[i].count+'</span>':'';
        ...
        fetch('/ajax/chat.php',{
            ...
            .then(response => {
                ...
                html += '                    </div>' +
                    ...
                    '                        <a href="" class="btn-send enviar_mensaje" data-chat-content="'+code+'" data-id-usuario="'+id_usuario+'" data-id-medico="'+id_medico+'">' +
